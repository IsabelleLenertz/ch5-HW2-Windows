...
;	Returns:	prints the asciii value to the consol
; Requires:	the print function du be working
;the array to store the new ascii value to be 16 bytes long
;-----------------------------------------------------------------------
...
MOV edx, 16
SUB edx, edi
MOV msg_size, edx   ; The length of the data to print is moved to the message_size variable (required by the DisplayText function)


ADD esi, edi        ; The address of the beggining of the data to print is moved to esi.
; copie the data to print into the message variable (required by the DisplayText procedure)
; TO DO
; loop length = edx
